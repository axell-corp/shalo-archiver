...
#if defined(_MSC_VER) && defined(_WIN64) && defined(FORCE_GCC_DEFAULT)
/* The type of long int must be 64bit long for Unix like environment simulator such MinGW64 and Cygwin x64 */
typedef unsigned __int64  CK_ULONG;
typedef __int64           CK_LONG;
#else
